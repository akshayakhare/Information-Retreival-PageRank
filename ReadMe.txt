...
2. Unzip the file "Akshaya_Khare_CS6200_HW2.zip" to get the contents
3. The file 'Page_Rank_with_in_links.py' contains the algorithm for page rank
4. Change the location of the output file if needed on line 187 & 199, else it will print the output files in the same location
5. In order to execute the Page_Rank_with_in_links.py file, go to python shell and type  
	execfile('Page_Rank_with_in_links.py')
6. Provide the necessary file name or path name as mentioned in the screen
